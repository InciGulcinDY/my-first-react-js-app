  ...
  return (
    <div className='container-fluid'>
        ...
        <Link className="navbar-brand btn" to="/" onClick={props.signIn} >
            <svg xmlns="http://www.w3.org/2000/svg" width="18" height="18" fill="currentColor" class="bi bi-person-check mb-1" viewBox="0 0 16 16">
        ...
        <Link className="navbar-brand btn" to="/">
            <svg xmlns="http://www.w3.org/2000/svg" width="18" height="18" fill="currentColor" class="bi bi-person-add mb-1" viewBox="0 0 16 16">
