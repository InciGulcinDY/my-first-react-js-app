        ...
        <nav className="navbar navbar-expand-lg navbar-light bg-light fixed-top">
            <div className="container-fluid">
              ...
              <div className='container-fluid col-12 col-md-4'>
                <Link className="navbar-brand btn" to="/">Home</Link>
                <Link className="navbar-brand btn" to="/">All Products</Link>
                <Link className="navbar-brand btn" to="/">
                  <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor" className="bi bi-phone mb-1" viewBox="0 0 16 16">
                ...
                <Link className="navbar-brand btn" to="/">
                  <svg xmlns="http://www.w3.org/2000/svg" width="18" height="18" fill="currentColor" className="bi bi-laptop mb-1" viewBox="0 0 16 16">
